...
<body>
	...
	<span style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif';font-size: 30px;font-weight: bold; color: #000000; text-shadow:2px 5px 2px #4cff00;">ĐĂNG NHẬP TÀI KHOẢN BỆNH NHÂN</span>
	</div>
            ...
            <div class="auth-form__container">
                ...
                <div class="auth-form__form">
                    <div class="auth-form__group">
                        <input type="number" class="auth-form__input" name="txtuser" placeholder="Số điện thoại ">
                    </div>
                    <div class="auth-form__group">
                ...
                <div class="auth-form__policy">
                    <div class="auth-form__help">
                        <a href="QuanTriHeThong/DangNhapQTHT.php" class="auth-form__help-link auth-form__help-forgot">Quản trị hệ thống</a>
                ...
                <div class="auth-form__controls">
                    <button class="btn auth-form__controls-back">
                        <a href="index.php" class="btn auth-form__controls-back"  >
                            TRỞ LẠI
                        </a>
                    </button>
