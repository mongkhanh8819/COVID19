...
<body>
	<div align="center">
	<span style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif';font-size: 30px;font-weight: bold; color: #000000; text-shadow:2px 5px 2px #4cff00;">ĐĂNG NHẬP TÀI KHOẢN CÁN BỘ Y TẾ PHƯỜNG</span>
	</div>
            ...
            <div class="auth-form__container">
                ...
                <div class="auth-form__policy">
                   <div class="auth-form__help">
                        ...
                        <a href="../QuanTriHeThong/DangNhapQTHT.php" class="auth-form__help-link">Quản trị hệ thống</a>
                    </div>
                </div>
					 ...
					 switch ($_POST['dangnhap'])
					 {
						 case 'Đăng nhập':
						 {
							 ...
							 if($user!='' && $pass!='')
							 {
								 ...
								 {
										header("location:TrangChuCBYTP.php"); 
